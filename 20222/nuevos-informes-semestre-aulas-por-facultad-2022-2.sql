/* Nuevos informes semestre Aulas por Facultad 2022-2 (2022-06-18)*/
...
(
    ...
    (
        ...
        = ccc.name
        ORDER BY c.id ASC
    ) AS aulasactivas, /* Aulas con estudiantes activos para el periodo 2022-2*/ 
    ...
    (
        ...
        = ccc.name
        ORDER BY c.id ASC
    ) AS pregrado, /* Aulas con estudiantes activos para el periodo 2022-2*/ 
