...
SELECT DISTINCT ccc.name AS "Id", "2022" AS "AÑO", "II" AS "PERIODO/SEMESTRE", REPLACE(ccc.name,"Facultad de ","") AS "FACULTAD/DEPENDENCIA",
...
(
    ...
    = ccc.name
    ORDER BY c.id ASC
) AS "AULAS ACTIVAS", /* Aulas con estudiantes activos para el periodo 2022-2*/ 
