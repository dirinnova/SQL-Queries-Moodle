/* Nuevos informes semestre Inscripciones - Estudiantes 2023-1 */
...
FROM 
(
    SELECT DISTINCT ccc.name AS idfacultades, REPLACE(ccc.name,"Facultad de ","") AS facultaddependencia,"2023-I" AS aniosemestre,
