/* Nuevos informes semestre Histórico Aulas Virtuales 2023-1 */
...
FROM 
(
    SELECT DISTINCT ccc.name AS Idfacultad,REPLACE(ccc.name,"Facultad de ","") AS facultaddependencia, "2023-I" AS aniosemestre,
