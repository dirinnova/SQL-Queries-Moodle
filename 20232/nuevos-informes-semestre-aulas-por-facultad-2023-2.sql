/* Nuevos informes semestre Aulas por Facultad 2023-2 (2023-01-01)*/
...
(
    ...
    (
        ...
        = ccc.name
        ORDER BY c.id ASC
    ) AS aulasactivas, /* Aulas con estudiantes activos para el periodo 2023-2*/ 
    ...
    (
        ...
        = ccc.name
        ORDER BY c.id ASC
    ) AS pregrado, /* Aulas con estudiantes activos para el periodo 2023-2*/ 
