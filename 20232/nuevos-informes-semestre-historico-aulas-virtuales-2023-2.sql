/* Nuevos informes semestre Histórico Aulas Virtuales 2023-2 */
...
FROM 
(
    SELECT DISTINCT ccc.name AS Idfacultad,REPLACE(ccc.name,"Facultad de ","") AS facultaddependencia, "2023-II" AS aniosemestre,
